    ...
    private void messageListener(DataInputStream dataInputStream) throws IOException {
        while (true) {
            ...
            if (newMessage.equals("/exit")) {
                ...
                int messIndex = newMessage.indexOf(" ", 3);
                String nick = newMessage.substring(3, messIndex);
                String message = newMessage.substring(3).substring(messIndex);
                server.messageName(client, nick, message);
            } else {
